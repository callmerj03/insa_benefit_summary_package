...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //         "value": "<p>Up to </p><b>₹10,00,000</b>",
    //         "tooltip":
    //             "Limit on the ICU expenses incurred during hospitalisation."
    //       },
    //       "AMBULANCE_CHARGES": {
    ...
    //         "tooltip":
    //             "Expenses before and post a hospitalisation that is related to the hospitalisation"
    //       },
    //       "AYUSH_TREATMENT_COVERAGE": {
    //         "key": "<b>Ayush Treatment Coverage</b>",
    //         "value": "<p>Up to the </p><b>₹10,00,000</b>",
    //         "tooltip":
    //             "Treatment under Ayurveda, Unani, Siddhi, Homeopathy branches of medicine"
    //       },
    //       "DAY_CARE_TREATMENTS": {
    //         "key": "<b>Single-Day Surgeries (Day Care Treatments )</b>",
    //         "value": "<p>Up to the </p><b>₹10,00,000</b>",
    //         "tooltip":
    //             "Expenses for procedures that can be performed in the hospital in under 24 hours."
    //       },
    //       "HOSPITALISATION_AT_HOME": {
    //         "key":
    //             "<b>Hospitalisation at home (Domicilliary Hospitalization)</b>",
    //         "value":
    ...
    //         "tooltip":
    //             "Expenses for treatment at home when patient cannot be admitted to the hospital."
    //       },
    //       "HEALTH_CHECK_UP": {
    //         "key": "<b>Health Check Up</b>",
    //         "value":
    //             "<button>Table attached Sum Insured wise :healthCheckUp</button>",
    //         "tooltip":
    //             "Annual preventive health check up to determine general health and wellness of the insured"
    //       },
    ...
    //         "tooltip":
    //             "Treatment using advanced medical technology or procedures"
    //       },
    //       "MODERN_TREATMENT_COVERAGE_LIST": null,
    //       "MODERN_TREATMENT_SUB_LIMITS": [
    //         {
    //           "treatment": "Uterine artery Embolization & HIFU",
    //           "coverage1": "Up to 10,00,000"
    //         },
    ...
    //         },
    //         {
    //           "treatment": "Oral Chemotherapy (Pre & Post Hosp.)",
    //           "coverage1": "Up to 10,00,000"
    //         },
    //         {
    //           "treatment": "Immunotherapy (Monoclonal Antibody)",
    //           "coverage1": "Up to 10,00,000"
    //         },
    //         {
    ...
    //         {
    //           "treatment": "Stereotactic Radiosurgeries",
    //           "coverage1": "Up to 10,00,000"
    //         },
    //         {
    //           "treatment": "Bronchial Thermoplasty",
    //           "coverage1": "Up to 10,00,000"
    //         },
    //         {
    //           "treatment":
    //               "Vaporation of Prostate (Green/Holmium Laser Treatment)",
    //           "coverage1": "Up to 10,00,000"
    //         },
    //         {
    //           "treatment": "IONM (Intraoperative Neuro Monitoring)",
    //           "coverage1": "Up to 10,00,000"
    //         },
    //         {
    //           "treatment": "Stem Cell Therapy (Haematopoietic stem cells)",
    //           "coverage1": "Up to 10,00,000"
    //         }
    //       ],
    ...
    //         "value": "<p>Not Covered</p>",
    //         "tooltip":
    //             "Fixed daily/incident-based cash payment to insured while hospitalized"
    //       },
    //       "CATARACT_COVERAGE": {
    //         "key": "<b>Cataract Coverage</b>",
    //         "value": "<p>Covered</p>",
    //         "tooltip":
    //             "Coverage for cataract surgery including pre/post hospitalization"
    //       },
    ...
    //         "value": "<p>Not Covered</p>",
    //         "tooltip":
    //             "In patient psychiatric treatment coverage for mental health conditions"
    //       },
    //       "INFERTILITY_TREATMENT": {
    //         "key": "<b>Infertility Treatment</b>",
    //         "value": "<p>Not Covered</p>",
    //         "tooltip":
    //             "Coverage for fertility treatments, including IVF procedures"
    //       },
    //       "MATERNITY_BENEFITS": {
    ...
    //         "key":
    //             "<b>Weight Reduction Surgeries (Morbid Obesity surgeries)</b>",
    //         "value":
    ...
    //         "key":
    //             "<b>Eye Power Correction (Correction of Refractive Error)</b>",
    //         "value":
    //             "<p>Covers poor eyesight that needs glasses or lenses stronger than 7.5 dioptres.</p>",
    //         "tooltip":
    ...
    //         "key":
    //             "<b>Hospitalization expenses for treatment of New Born Baby(per policy period)</b>",
    //         "value":
    ...
    //         "tooltip":
    //             "Only accidental claims are covered in the first 30 days of policy."
    //       },
    ...
    //         "tooltip":
    //             "These are a specific set of diseases that are covered after a specified waiting period."
    //       },
    //       "NAMED_AILMENT_LIST": [
    //         {
